...
type rpcConfig struct {
	...
	streamCallbackConfig *streaming.StreamCallbackConfig
}
...
func (r *rpcConfig) SetStreamCallbackConfig(cfg *streaming.StreamCallbackConfig) {
	r.streamCallbackConfig = cfg
}

func (r *rpcConfig) StreamCallbackConfig() *streaming.StreamCallbackConfig {
	return r.streamCallbackConfig
}
