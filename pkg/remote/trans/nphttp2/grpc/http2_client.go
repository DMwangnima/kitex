...
func (t *http2Client) NewStream(ctx context.Context, callHdr *CallHdr) (_ *Stream, err error) {
	...
	t.reportStreamStartEvent(s, rpcinfo.StreamStartEvent{})
...
func (t *http2Client) closeStream(s *Stream, err error, rst bool, rstCode http2.ErrCode, st *status.Status, mdata map[string][]string, eosReceived bool) {
	...
	t.reportStreamFinishEvent(s, rpcinfo.StreamFinishEvent{Trailer: mdata})
	if err != nil {
...
func (t *http2Client) operateHeaders(frame *grpcframe.MetaHeadersFrame) {
	...
	if atomic.CompareAndSwapUint32(&s.headerChanClosed, 0, 1) {
		...
		if !endStream {
			...
			t.reportStreamRecvHeaderEvent(s, rpcinfo.StreamRecvHeaderEvent{Header: s.header})
		} else {
